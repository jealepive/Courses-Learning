...
z_2 = a_1 * Theta1';  % m x hidden_layer_size == 5000 x 25
a_2 = sigmoid(z_2); % m x hidden_layer_size == 5000 x 25
a_2 = [ones(size(a_2,1),1), a_2]; % Adding 1 as first column in z = (Adding bias unit) % m x (hidden_layer_size + 1) == 5000 x 26

z_3 = a_2 * Theta2';  % m x num_labels == 5000 x 10
...
delta_3 = a_3 - y_Vec; % 5000 x 10
delta_2 = (delta_3 * Theta2) .* [ones(size(z_2,1),1) sigmoidGradient(z_2)]; % 5000 x 26
